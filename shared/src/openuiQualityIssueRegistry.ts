...
export const OPENUI_QUALITY_ISSUE_SEVERITY_BY_CODE = {
  ...
  'duplicate-button-id': 'fatal-quality',
  'duplicate-component-id': 'fatal-quality',
  'duplicate-screen-id': 'fatal-quality',
  'unsafe-url-literal': 'fatal-quality',
  'unknown-action-run-reference': 'fatal-quality',
  'unknown-mutation-reference': 'fatal-quality',
  'unknown-query-reference': 'fatal-quality',
  'all-conditional-screens-hidden-initially': 'blocking-quality',
  ...
  'navigate-screen-missing-target': 'blocking-quality',
  ...
  'set-current-screen-missing-target': 'blocking-quality',
  'undefined-state-reference': 'blocking-quality',
  'orphan-screen': 'soft-warning',
