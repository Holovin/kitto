    ...
    await promptLog.write(
      {
        ...
        budgetDecision: promptContextMetadata?.budgetDecision,
        committedSourceChars: promptContextMetadata?.committedSourceChars ?? request.currentSource.length,
        committedSourceIncluded: promptContextMetadata?.committedSourceIncluded,
        committedSourceProtected: promptContextMetadata?.committedSourceProtected,
        ...
        repairPromptMaxChars: promptContextMetadata?.repairPromptMaxChars,
        usage: options.usage,
