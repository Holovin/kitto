...
const chatPanelSourcePath = path.resolve(currentDirectory, '../../../../features/builder/components/ChatPanel.tsx');
const previewTabsSourcePath = path.resolve(currentDirectory, '../../../../features/builder/components/PreviewTabs.tsx');
