...
export const selectCurrentRequestId = (state: RootState) => state.builder.currentRequestId;
...
export const selectDefinitionSource = (state: RootState) =>
  selectIsStreaming(state) || selectHasRejectedDefinition(state) ? state.builder.streamedSource : state.builder.committedSource;
